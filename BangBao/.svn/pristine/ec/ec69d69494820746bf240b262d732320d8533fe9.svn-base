...
public class EmojiAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		image.setImageResource(express[position]);
		return image;
	}

	public static int[] express = { R.drawable.f000, R.drawable.f001,
			...
			R.drawable.f090, R.drawable.f051, R.drawable.f052, R.drawable.f053,
			R.drawable.f054, R.drawable.f095, R.drawable.f096, R.drawable.f097,
