...
public class ViewPagerIndicator extends LinearLayout {
	 ...
	 * 三角形的最大宽度
	 */
	private final int DIMENSION_TRIANGEL_WIDTH = (int) (getScreenWidth() / 4 * RADIO_TRIANGEL);
	...
	public ViewPagerIndicator(Context context, AttributeSet attrs) {
		...
		mPaint.setPathEffect(new CornerPathEffect(4));// 一个界面显示多少个tab的item
	...
	private void initTriangle() {
		...
		mTriangleHeight = (int) (mTriangleWidth / 8 / Math.sqrt(2));
		mPath.moveTo(0, 0);
		mPath.lineTo(mTriangleWidth, 0);// lineTo连接两点直线
