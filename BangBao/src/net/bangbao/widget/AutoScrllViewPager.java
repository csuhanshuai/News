 ...
 */
public class AutoScrllViewPager extends ViewPager {
    ...
    public AutoScrllViewPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public AutoScrllViewPager(Context paramContext, AttributeSet paramAttributeSet) {
