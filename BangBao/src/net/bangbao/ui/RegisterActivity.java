...
public class RegisterActivity extends BaseActivity implements View.OnClickListener, ConnectCallback {
    ...
    private void initViews() {
        ...
        mServiceItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RegisterActivity.this, BangBaoServiceItemActivity.class));
            }
        });
        initTextWatcher();
    }
    ...
    public void mComplete() {
        ...
        if (!mPassword.getText().toString().trim()
                .endsWith(mPasswordConform.getText().toString().trim())) {
        ...
        mProgressBar.show();
        apiClient.registerUser(registerStruct, this, BaseApi.class,
                new ApiClient.CallBack<BaseApi>() {
                    ...
                    public void success(BaseApi api) {
                        ...
                        if (api == null) return;
                        if (api.getRet_cd() == 0) {
                            UIHelper.showToastMessage("注册成功！");
                            /**去登陆 **/
                            gotoLogin();
                        }
    ...
    private void gotoLogin() {
        apiClient.loginUser(mUserName.getText().toString(), mPassStr, this, LoginUserApi.class,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.pros_setting:
                ...
                mPassProblems =
                        new SpinnerDropDown(questions, this, v.getMeasuredWidth(),
                ...
                mPassProblems.setPopwindowHeight(LayoutParams.WRAP_CONTENT);
            ...
            case R.id.comm_layout:
                ...
                spinnerDropDown =
                        new SpinnerDropDown(items, RegisterActivity.this, v.getMeasuredWidth(),
                                new IOnClickItemListener() {
                ...
                spinnerDropDown.setPopwindowHeight(LayoutParams.WRAP_CONTENT);
